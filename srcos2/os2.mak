...
LDEBUG=/DEBUG
!endif
CFLAGS=-O2 -Wall -Zomf -Zargs-wild $(CDEBUG) -DOS2 -DNONAG -Zhigh-mem
LDFLAGS= -O2 -Zdll -Zomf -DOS2 -DNONAG -Zhigh-mem
...
$(LANGOBJ): $(SRCOS2)gvplang.c
	$(COMP) $(FOO)gvplang$(OBJ) $(CO) $(SRCOS2)gvplang.c
...
$(OD)gvpmct.res: $(HDRS) $(SRCOS2)gvpm2.rc $(SRCOS2)gvpm3.rc $(CODEPAGE) $(BD)gvpmct.hlp ct\gvclang.h ct\gvclang.rc ct\gvplang.rc
        ...
        rc -i $(OBJDIR) -i $(SRCDIR) -r $(OD)gvpmct.rc $(OD)gvpmct.res

$(BD)gvpmct.dll: $(OD)gvpmct.res ct\gvplang.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)gvpmct.dll ct\gvplang.def $(LANGOBJ) -Zmap=$(OD)gvpmct.map
...
$(OD)setup2ct.res: $(SRCOS2)os2setup.rc $(SRCOS2)os2setup.h $(SRC)gvcrc.h $(SRC)gvcver.h ct\gvclang.h $(CODEPAGE)
	$(CODEPAGE) 1252 850 ct\gvclang.h $(OD)gvclang.h
	rc -i $(OBJDIR) -i $(SRCDIR) -i $(SRCOS2) -r $(SRCOS2)os2setup.rc $(OD)setup2ct.res

$(BD)setup2ct.dll: $(OD)setup2ct.res ct\setup2.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)setup2ct.dll ct\setup2.def $(LANGOBJ) -Zmap=$(OD)setup2ct.map 
...
$(BD)gvpmde.dll: $(OD)gvpmde.res de\gvplang.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)gvpmde.dll de\gvplang.def $(LANGOBJ) -Zmap=$(OD)gvpmde.map
...
$(BD)setup2de.dll: $(OD)setup2de.res de\setup2.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)setup2de.dll de\setup2.def $(LANGOBJ) -Zmap=$(OD)setup2de.map
...
$(BD)gvpmes.dll: $(OD)gvpmes.res es\gvplang.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)gvpmes.dll es\gvplang.def $(LANGOBJ) -Zmap=$(OD)gvpmes.map
...
$(BD)setup2es.dll: $(OD)setup2es.res es\setup2.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)setup2es.dll es\setup2.def $(LANGOBJ) -Zmap=$(OD)setup2es.map
...
$(BD)gvpmfr.dll: $(OD)gvpmfr.res fr\gvplang.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)gvpmfr.dll fr\gvplang.def $(LANGOBJ) -Zmap=$(OD)gvpmfr.map
...
$(BD)setup2fr.dll: $(OD)setup2fr.res fr\setup2.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)setup2fr.dll fr\setup2.def $(LANGOBJ) -Zmap=$(OD)setup2fr.map
...
$(BD)gvpmgr.dll: $(OD)gvpmgr.res gr\gvplang.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)gvpmgr.dll gr\gvplang.def $(LANGOBJ) -Zmap=$(OD)gvpmgr.map
...
$(BD)setup2gr.dll: $(OD)setup2gr.res gr\setup2.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)setup2gr.dll gr\setup2.def $(LANGOBJ) -Zmap=$(OD)setup2gr.map
...
$(BD)gvpmit.dll: $(OD)gvpmit.res it\gvplang.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)gvpmit.dll it\gvplang.def $(LANGOBJ) -Zmap=$(OD)gvpmit.map
...
$(BD)setup2it.dll: $(OD)setup2it.res it\setup2.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)setup2it.dll it\setup2.def $(LANGOBJ) -Zmap=$(OD)setup2it.map
...
$(BD)gvpmnl.dll: $(OD)gvpmnl.res nl\gvplang.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)gvpmnl.dll nl\gvplang.def $(LANGOBJ) -Zmap=$(OD)gvpmnl.map
...
$(BD)setup2nl.dll: $(OD)setup2nl.res nl\setup2.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)setup2nl.dll nl\setup2.def $(LANGOBJ) -Zmap=$(OD)setup2nl.map
...
$(BD)gvpmru.dll: $(OD)gvpmru.res ru\gvplang.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)gvpmru.dll ru\gvplang.def $(LANGOBJ) -Zmap=$(OD)gvpmru.map
...
$(BD)setup2ru.dll: $(OD)setup2ru.res ru\setup2.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)setup2ru.dll ru\setup2.def $(LANGOBJ) -Zmap=$(OD)setup2ru.map
...
$(BD)gvpmse.dll: $(OD)gvpmse.res se\gvplang.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)gvpmse.dll se\gvplang.def $(LANGOBJ) -Zmap=$(OD)gvpmse.map
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)gvpmse.dll se\gvplang.def $(LANGOBJ) -Zmap=$(OD)gvpmse.map
...
$(BD)setup2se.dll: $(OD)setup2se.res se\setup2.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)setup2se.dll se\setup2.def $(LANGOBJ) -Zmap=$(OD)setup2se.map
...
$(BD)gvpmsk.dll: $(OD)gvpmsk.res sk\gvplang.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)gvpmsk.dll sk\gvplang.def $(LANGOBJ) -Zmap=$(OD)gvpmsk.map
...
$(BD)setup2sk.dll: $(OD)setup2sk.res sk\setup2.def $(LANGOBJ)
	$(CC) $(LDFLAGS) $(LDEBUG) -o $(BD)setup2sk.dll sk\setup2.def $(LANGOBJ) -Zmap=$(OD)setup2sk.map
...
$(BD)os2setup.exe: $(OD)os2setup.res $(SRCOS2)os2setup.def $(SETUPOBJS)
	$(CCAUX) -Zomf $(DEBUGFLAG) $(FE) $(BD)os2setup.exe $(SETUPOBJS) $(SRCOS2)os2setup.def
